...
def macroop VMULPS_XMM_XMM {
    vmulf dest=xmm0, src1=xmm1v, src2=xmm2, size=4, VL=16
    vclear dest=xmm2, destVL=16
};
def macroop VMULPS_XMM_M {
    ldfp ufp0, seg, sib, "DISPLACEMENT", dataSize=8
    ldfp ufp1, seg, sib, "DISPLACEMENT + 8", dataSize=8
    vmulf dest=xmm0, src1=xmm1v, src2=ufp0, size=4, VL=16
    vclear dest=xmm2, destVL=16
};
def macroop VMULPS_YMM_YMM {
    vmulf dest=xmm0, src1=xmm1v, src2=xmm2, size=4, VL=32
};
def macroop VMULPS_YMM_M {
    ...
    vmulf dest=xmm0, src1=xmm1v, src2=ufp0, size=4, VL=32
};
'''